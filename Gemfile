...
ruby '2.3.0'
#ruby-gemset=employee-attendance-gemset
...
# Modal preferible used to display images.
gem 'fancybox2-rails', '~> 0.2.8'

# Gem wrapper to include the Modernizr.js.
gem 'modernizr-rails'

# iCheck gem style for checkboxes.
gem 'icheck-rails', '~> 1.0.2.2'

# Allows create seed data files from the existing data in your database.
gem 'seed_dump', '~> 3.2.2'
