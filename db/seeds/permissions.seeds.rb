Permission.create!([
  {name: "Crear Usuario", description: "Permite crear un usuario.", action: "create", controller: "Users::Registrations"},
  ...
  {name: "Nuevo Usuario", description: "Permite visualizar la vista nuevo usuario.", action: "new", controller: "Users::Registrations"},
  ...
  {name: "Actualizar Usuario", description: "Permite actualizar un usuario.", action: "update", controller: "Users::Registrations"},
  ...
  {name: "Mostrar Listado De Los Permisos", description: "Permite mostrar un listado de los permisos.", action: "index", controller: "Permissions"},
  ...
  {name: "Mostrar Listado De Los Roles", description: "Permite mostrar un listado de los roles.", action: "index", controller: "Roles"},
